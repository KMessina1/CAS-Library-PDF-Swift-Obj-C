...
©2015-2017 Creative App Solutions, LLC. - All Rights Reserved.
----------------------------------------------------------------------------------------------------------------------------
...
// MARK: - *** FUNCTIONS: PAGE SETUP ***
    func setPaperSize(_ paperSize:PaperSize) {
    ...
    func setPageAppearance(pageNum_Show:Bool,
    ...
    func newPage(title:String) {
        ...
        if pdfPageSize.pageNum_Show! {
            ...
            drawPageNumber(pdfCurrentVals.pageNum)
        }
        ...
        if pdfPageSize.logo_Show! {
            drawImage(img: UIImage(named:"iTunes Artwork")!,
...
// MARK: - *** FUNCTIONS: PAGE COMPLETION ***
    func createAtFilePath(_ fileNameAndPath:String) {
...
// MARK: - *** FUNCTIONS: DRAWING ***
    ...
    func drawPageNumber(_ pageNum:Int!, customY:CGFloat? = 0.0) -> Void {
        ...
        let attribs:[String:Any] = [NSFontAttributeName:defaultFont,NSParagraphStyleAttributeName:style]
        let pageStringSize:CGSize! = pageString.size(attributes: attribs)
    ...
    func drawText(text:String,fontName:String,fontSize:CGFloat,inRect:CGRect,alignment:NSTextAlignment,color:UIColor? = .black) -> Void {
        ...
        let attribs = [NSFontAttributeName:UIFont(name:fontName,size:fontSize) ?? UIFont.systemFont(ofSize:fontSize),
    ...
    func drawSizedText(text:String,
        ...
        var attribs = [NSFontAttributeName:UIFont(name:fontName,size:fontSize) ?? UIFont.systemFont(ofSize:fontSize),
                       NSParagraphStyleAttributeName:style,
                       NSForegroundColorAttributeName:color!] as [String : Any]
        ...
        repeat{
            fontSize -= 1
            attribs = [NSFontAttributeName:UIFont(name:fontName,size:fontSize) ?? UIFont.systemFont(ofSize:fontSize),
                       NSParagraphStyleAttributeName:style,
                       NSForegroundColorAttributeName:color!] as [String : Any]
            stringSize = text.size(attributes: attribs)
    ...
    func drawSizedTextMultiline(text:String,fontName:String,size_Max:CGFloat,size_Min:CGFloat,alignment:NSTextAlignment,inRect:CGRect,color:UIColor? = .black) -> Void {
        ...
        repeat {
            ...
            attribs = [NSFontAttributeName:UIFont(name:fontName,size:fontSize) ?? UIFont.systemFont(ofSize:fontSize),
                       NSParagraphStyleAttributeName:style,
                       NSForegroundColorAttributeName:color!] as [String : Any]
            htNeeded = NSAttributedString().heightNeeded(txt: text, maxWidth: inRect.width, attribs: attribs)
...
/// Draw image on page.
    ...
    func drawAppStoreLogo(position: kAlignment) {
        ...
        drawImage(img: UIImage(named: "AppStoreBadge")!,
                 rect: CGRect(x: margin_Left,
                              y: pdfCurrentVals.margin_Bottom,
                          width: badgeWidth,
                         height: 25),
             linkShow: true,
                 link: appInfo.EDITION.appStoreExt_URL)
    }
...
extension NSAttributedString {
    func heightNeeded(txt:String, maxWidth:CGFloat, attribs:[String : Any]) -> CGFloat {
